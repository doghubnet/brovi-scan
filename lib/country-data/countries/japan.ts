...
export const japanPack: CountryData = withBase({
  countryCode: "JP",
  countrySlug: "japan",
  countryName: "Japan",
  status: "active",
  lastReviewed: "2026-05-19",
  officialSourceNotes: ['Study in Japan lists passport, visa, and Certificate of Eligibility as key entry-related documents.', 'Certificate of Eligibility may be issued before visa application.', 'The institution often supports COE procedures.', 'Arrival and residence procedures may apply after entry.'],
  requiredVerificationMessage: createOfficialVerificationMessage("Japan"),
