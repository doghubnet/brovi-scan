...
export const francePack: CountryData = withBase({
  countryCode: "FR",
  countrySlug: "france",
  countryName: "France",
  status: "active",
  lastReviewed: "2026-05-19",
  officialSourceNotes: ['France-Visas specifies supporting documents through the visa wizard.', 'Student applicants must especially include the certificate of enrolment in the higher education institution that accepted them.', 'VLS-TS student visa can allow study for four months to one year and must be validated after arrival.', 'Campus France or Etudes en France steps may be relevant depending on country and program.'],
  requiredVerificationMessage: createOfficialVerificationMessage("France"),
