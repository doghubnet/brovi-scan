...
export const australiaPack: CountryData = withBase({
  countryCode: "AU",
  countrySlug: "australia",
  countryName: "Australia",
  status: "active",
  lastReviewed: "2026-05-19",
  officialSourceNotes: ['Subclass 500 Student visa applicants must generally be enrolled in a course of study.', 'A valid Confirmation of Enrolment may be needed when the decision is made.', 'Financial capacity evidence is required.', 'Living costs vary by location and must be researched beyond visa minimums.'],
  requiredVerificationMessage: createOfficialVerificationMessage("Australia"),
