...
export const newzealandPack: CountryData = withBase({
  countryCode: "NZ",
  countrySlug: "new-zealand",
  countryName: "New Zealand",
  status: "active",
  lastReviewed: "2026-05-19",
  officialSourceNotes: ['Applicants normally include an offer of place from the education provider.', 'Medical certificates, police certificates, and translations may be required.', 'Pathway student visa applicants may need tuition payment documents and evidence for later years.', 'Official Immigration New Zealand instructions must be checked for each case.'],
  requiredVerificationMessage: createOfficialVerificationMessage("New Zealand"),
