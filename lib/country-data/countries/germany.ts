...
export const germanyPack: CountryData = withBase({
  countryCode: "DE",
  countrySlug: "germany",
  countryName: "Germany",
  status: "active",
  lastReviewed: "2026-05-19",
  officialSourceNotes: ["Use the German Embassy or Consulate checklist for the applicant's country.", 'Study and language course visa categories may have different supporting documents.', 'Documents often include application form, biometric photo, valid passport, admission-related proof, language proof, and financial proof.', 'Do not invent blocked account amounts unless current official source data is added.'],
  requiredVerificationMessage: createOfficialVerificationMessage("Germany"),
