...
export const unitedstatesPack: CountryData = withBase({
  countryCode: "US",
  countrySlug: "united-states",
  countryName: "United States",
  status: "active",
  lastReviewed: "2026-05-19",
  officialSourceNotes: ['Students normally need admission from a SEVP-approved school.', 'The school issues Form I-20 after acceptance and SEVIS registration.', 'The applicant pays the SEVIS I-901 fee before visa steps.', 'The student applies for an F or M visa through a U.S. Embassy or Consulate.', 'Form I-20 must be presented at the visa interview.'],
  requiredVerificationMessage: createOfficialVerificationMessage("United States"),
