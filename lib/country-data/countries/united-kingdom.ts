...
export const unitedkingdomPack: CountryData = withBase({
  countryCode: "GB",
  countrySlug: "united-kingdom",
  countryName: "United Kingdom",
  status: "active",
  lastReviewed: "2026-05-19",
  officialSourceNotes: ['UK Student visa applicants provide a current passport or valid travel document.', 'The course provider issues a Confirmation of Acceptance for Studies, CAS.', 'Financial evidence may be required to show course fees and living costs.', 'Some applicants may have different evidence requirements depending on nationality and visa history.'],
  requiredVerificationMessage: createOfficialVerificationMessage("United Kingdom"),
