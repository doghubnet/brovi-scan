...
export const chinaPack: CountryData = withBase({
  countryCode: "CN",
  countrySlug: "china",
  countryName: "China",
  status: "active",
  lastReviewed: "2026-05-19",
  officialSourceNotes: ['Student visa applicants may use X1 or X2 depending on study duration.', 'X1 long-term study applications can require admission notice and JW201 or JW202.', 'X1 visa holders may need to apply for a residence permit within 30 days after entry.', 'Physical examination or other documents may be required depending on route and institution.'],
  requiredVerificationMessage: createOfficialVerificationMessage("China"),
