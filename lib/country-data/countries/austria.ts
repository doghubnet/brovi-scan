...
export const austriaPack: CountryData = withBase({
  countryCode: "AT",
  countrySlug: "austria",
  countryName: "Austria",
  status: "active",
  lastReviewed: "2026-05-19",
  officialSourceNotes: ['Residence Permit – Student is intended for third-country nationals admitted to study at an Austrian higher education institution.', 'Applications for residence permits are generally submitted from abroad before entry.', 'Admission, accommodation, financial means, and health insurance can be important categories.', 'Visa D may be relevant for entry to collect a residence permit in some processes.'],
  requiredVerificationMessage: createOfficialVerificationMessage("Austria"),
