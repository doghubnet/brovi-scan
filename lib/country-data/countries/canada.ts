...
export const canadaPack: CountryData = withBase({
  countryCode: "CA",
  countrySlug: "canada",
  countryName: "Canada",
  status: "active",
  lastReviewed: "2026-05-19",
  officialSourceNotes: ['Canada study permit applicants need the correct documents according to IRCC.', 'PAL or TAL is needed in most cases.', 'Quebec cases may need CAQ instead of PAL or TAL.', 'Proof of identity and proof of financial support are key categories.', 'Some documents vary by applicant profile.'],
  requiredVerificationMessage: createOfficialVerificationMessage("Canada"),
