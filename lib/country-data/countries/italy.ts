...
export const italyPack: CountryData = withBase({
  countryCode: "IT",
  countrySlug: "italy",
  countryName: "Italy",
  status: "active",
  lastReviewed: "2026-05-19",
  officialSourceNotes: ['Non-EU citizens may need a student visa through the Italian Embassy or Consulate.', 'Universitaly pre-enrolment can be relevant for Italian higher education applications.', 'Evaluation of foreign qualifications for enrolment belongs to the higher education institution.', 'Declaration of Value or CIMEA may be relevant depending on university and procedure.', 'Do not store the 2025/2026 November 30, 2025 deadline as current. It is historical and already past.'],
  requiredVerificationMessage: createOfficialVerificationMessage("Italy"),
